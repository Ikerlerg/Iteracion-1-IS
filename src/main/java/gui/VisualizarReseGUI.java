...
public class VisualizarReseGUI extends JFrame {
	...
	private final JLabel jLabelReseñas = new JLabel(ResourceBundle.getBundle("Etiquetas").getString("VisualizarReseGUI.reseña")); 
	...
	public VisualizarReseGUI(String email) {
		 ...
		 jButtonSearch.addActionListener(new ActionListener() {
		 	public void actionPerformed(ActionEvent e) {
		 		try {
					...
					if (valoraciones.isEmpty() ) jLabelReseñas.setText(ResourceBundle.getBundle("Etiquetas").getString("VisualizarReseGUI.noreseñas"));
					else jLabelReseñas.setText(ResourceBundle.getBundle("Etiquetas").getString("VisualizarReseGUI.sireseñas"));
